    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between border-b border-border/40 pb-2">
          ...
          <span className="font-mono text-[11px] text-muted-foreground">
            {topIssues.length} fault patterns
          </span>
        </div>

        <div className="space-y-3">
          {topIssues.length === 0 ? (
            <p className="text-xs text-muted-foreground py-2">No anomalies recorded.</p>
          ) : (
              ...
              return (
                <div key={issue.label} className="group space-y-1.5 text-xs">
                  <div className="flex items-center justify-between font-mono">
                    <span className="font-sans font-medium text-foreground truncate max-w-[220px]" title={issue.label}>
                      {issue.label}
                    </span>
      ...
      <div className="space-y-3 border-t border-border/50 pt-4">
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[11px] text-muted-foreground">
            {totalSeverityCount} total incidents
          </span>
        </div>
